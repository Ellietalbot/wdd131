...
function validateForm(event) {
  ...
  function togglePaymentDetails(e) {
    ...
    const creditCardContainer = document.getElementById('ccnum_container');
    const paypalContainer = document.getElementById('ppusername_container');
    ...
    if (theForm.pmethod.value === 'creditCard'){
        creditCardContainer.classList.remove('hide')
    } else if (theForm.pmethod.value === 'paypal'){
  ...
  document.querySelector('#checkoutForm select[name="pmethod"]').addEventListener('change', togglePaymentDetails);
  // attach a submit event handler to the form